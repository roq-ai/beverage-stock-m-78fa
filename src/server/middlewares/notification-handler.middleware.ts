...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Inventory.create': {
    roles: ['depot-supervisor', 'bottle-manager', 'inventory-clerk'],
    key: 'inventory_add',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['depot-supervisor'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['depot-supervisor', 'bottle-manager', 'inventory-clerk', 'end-customer'];
