...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`beverage stock management`}</title>

        <meta
          name="description"
          content="Beverage Stock Management - Unleashing the power of efficient logistics, from factory to depot, customer to bottle. Managing your beverage inventory and borrows with precision."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1485872299829-c673f5194813?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkcmlua3N8ZW58MHx8fHwxNjk2ODM1OTM2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mdisc?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Michael Discenza`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Beverage Stock Management - Unleashing the power of efficient logistics, from factory to depot, customer to bottle. Managing your beverage inventory and borrows with precision.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Depot Supervisor" type="depot-supervisor" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
